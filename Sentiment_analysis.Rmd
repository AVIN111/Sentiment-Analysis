...
```
 ...
 In this project we will use three general purpose lexicons like –
...
```
 ...
 We will now proceed towards counting the most common positive and negative words that are present in the novel.
...
```
 ...
 Now we will perform visualization of our sentiment score. Using ggplot() function. 
...
```
 ...
 Let's create a wordcloud for better and final visualization which will delineate the most recurring positive and negative words. In particular, we will use the comparison.cloud() function to plot both negative and positive words in a single wordcloud as follows:
